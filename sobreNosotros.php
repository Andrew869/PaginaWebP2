...
<body>
    ...
    <div id="nos">
        ...
        <table>
            ...
            <tr>
                <td class="text">Nuestra visión es ser líderes en la industria de desarrollo de software, reconocidos por nuestra excelencia técnica, innovación constante y compromiso inquebrantable con la satisfacción del cliente. Queremos marcar la diferencia en el mundo de la tecnología a través de los siguientes aspectos clave:
                ...
                <td><img src="img/imagen1.jpg" alt="Nuestra Oficina"></td>
            </tr>
            <tr>
                <td colspan="2">Contrataciones</td>
            </tr>
            <tr>
                <td><img src="img/imagen2.jpg" alt="Nuestro Equipo"></td>
                <td class="text">Si estás interesado en unirse a nuestro equipo o colaborar en un proyecto, aquí hay algunos requisitos clave que debes tener en cuenta:
